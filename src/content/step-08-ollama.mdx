...
<OsTabs>
  <Fragment slot="win">
    <div class="prose prose-slate dark:prose-invert max-w-none">
      ...
      Luego instala Ollama ([documentación oficial](https://docs.ollama.com/linux)):
      ...
      <Callout type="warning" title="Esta terminal queda ocupada">
        `ollama serve` deja el servidor corriendo en **primer plano**: esta terminal quedará bloqueada mientras Ollama funcione. Abre **otra** terminal de Ubuntu para ejecutar los comandos del paso siguiente (`ollama pull`, `ollama run`).

        Si al ejecutarlo ves `address already in use`, significa que Ollama **ya está corriendo** como servicio en segundo plano. Es normal: sáltate este comando y continúa.
      </Callout>
      ...
      <div class="not-prose mt-6 bg-purple-50 dark:bg-purple-950/30 p-4 rounded-lg border border-purple-100 dark:border-purple-800">
        ...
        <ol class="list-decimal list-inside text-sm text-purple-800 dark:text-purple-300 space-y-1 mb-2">
          ...
          <li>Abre con Bloc de notas y pega esto (ajusta `memory` y `processors` según tu equipo):</li>
        </ol>
      </div>
...
```
  ...
  <Fragment slot="mac">
    <div class="prose prose-slate dark:prose-invert max-w-none">
      ...
      Descarga la App oficial (universal: Intel y Apple Silicon): [Descargar Ollama para Mac](https://ollama.com/download/mac) · [Documentación oficial](https://docs.ollama.com/)
...
Son ~2 GB, así que la descarga puede tardar varios minutos según tu conexión. Verás una barra de progreso; espera a que llegue al 100%.
