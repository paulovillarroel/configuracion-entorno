...
<Callout type="tip" title="¿Quieres entender mejor los scripts y la terminal?">
  En esta sección usamos scripts Bash, crontab y redirección de salida. Si quieres profundizar en estos temas, revisa el [Curso de Terminal y Bash](https://paulovillarroel.github.io/curso-terminal-bash/#inicio) donde aprenderás a dominar la línea de comandos y automatizar tareas como un profesional.
</Callout>
