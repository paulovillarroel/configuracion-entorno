...
<Callout type="info" title="Si positron . no abre nada">
  Los comandos `ws`, `positron`, `uv`, `git` funcionan como palabras sueltas porque están en tu **PATH** — la lista de carpetas donde la terminal busca ejecutables. Si alguno dice "command not found", en [IDE & Verificación](#paso-12) tienes la guía completa para ver tu PATH y agregar rutas manualmente en Windows y Mac.
</Callout>
