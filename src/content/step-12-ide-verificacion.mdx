...
<Callout type="tip" title="Curso complementario: Terminal y Bash">
  Continúa con el [Curso de Terminal y Bash](https://paulovillarroel.github.io/curso-terminal-bash) para aprender a moverte con soltura en la línea de comandos, automatizar tareas y sacarle el máximo provecho a tu nuevo entorno.
</Callout>
